...
export default async function AdminPage() {
  ...
  if (authorised) { const adminName = user?.displayName || user?.email || (localMode ? "Local Admin" : "Administrator"); return <div className="admin-route"><main><div className="admin-preview-notice">{localMode ? "Local preview mode — sign-in protection will activate when hosted." : `Signed in as ${adminName}`}</div><AdminDashboard adminName={adminName} /></main></div>; }
