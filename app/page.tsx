  ...
  return (
    <main className="home-page">
      ...
      <section className="bg-[#edf5fb] section-space">
        <div className="container-shell grid items-center gap-8 sm:gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="relative mx-auto aspect-[3/2] w-full max-w-[23rem] overflow-hidden rounded-[1.5rem] bg-[#0a2a50] lg:max-w-none lg:min-h-[480px] lg:rounded-[2rem]"><img src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=1600&q=85" alt="Himalayan landscape near Nepal travel routes" className="absolute inset-0 h-full w-full object-contain lg:object-cover lg:object-center" loading="lazy" /><div className="absolute inset-0 bg-gradient-to-t from-[#06162b]/95 via-[#06162b]/15 to-transparent" /><div className="absolute inset-x-0 bottom-0 p-4 text-white sm:p-8"><p className="text-[0.62rem] font-semibold uppercase tracking-[0.18em] text-orange-300 sm:text-sm">Based in Raxaul</p><p className="mt-2 max-w-[14rem] text-[clamp(1.35rem,4vw,2.2rem)] font-extrabold leading-[1.08] tracking-[-0.03em] sm:max-w-none">Closer to the border.<br />Closer to your journey.</p></div></div>
